...
int makeLimitHist_TChiWH_sicong(TString new_cate = "", TString date_str = "", TString inverse_fb = "35.9", bool show_obs = false)
{
...
//  setTDRStyle();           
  ...
  TString plot_dir = "/home/users/siconglu/CMSTAS/software/niceplots/WH_Expected_Exclusion_0710/";
  ...
  double red[]   = {0.00/225, 0.00/225, 243./255, 255./255, 252./255};
  double green[] = {106./225, 198./225, 229./255, 205./255, 137./255};
  double blue[]  = {150./225, 215./255, 100./255, 0.00/255, 0.00/255};
  ...
  TH2F * h_axis = new TH2F("h_axis","",700,100,700,350,0,350);
...
//  clstex1->Draw();
  ...
  TLatex *cmstex = NULL;
  TString lumi_str = inverse_fb + " fb^{-1} (13 TeV)";
  cmstex = new TLatex(0.575,0.94, lumi_str);    
  cmstex->SetNDC();    
